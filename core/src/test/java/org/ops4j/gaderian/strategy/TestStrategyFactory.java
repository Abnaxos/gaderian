...
/**
 * Test for the {@link org.ops4j.gaderian.strategy.StrategyFactory} service
    ...
    public void testBuildImplementationClass()
    {
        ...
        expect( cf.addMethod(
                ...
                new MethodSignature( ToStringStrategy.class, "_getStrategy", new Class[]
                        { Object.class }, null ),
                "return (org.ops4j.gaderian.strategy.ToStringStrategy) _registry.getStrategy($1.getClass());" ) ).andReturn( mf );
