...
/**
 * Tests the {@link org.ops4j.gaderian.pipeline.BridgeBuilder} class.
 *
...
public class TestBridgeBuilder extends GaderianTestCase
{
    ...
    public void testStandard()
    {
        ...
        assertEquals(
                "<PipelineBridge for service foo.bar(org.ops4j.gaderian.pipeline.StandardService)>",
                bridge.toString());
        ...
        log
                .error(
                        "Method void extraFilterMethod() of filter interface "
                                + "org.ops4j.gaderian.pipeline.ExtraFilterMethod does not have a matching service "
