...
/**
 * A custom translator (meaning: not used enough to be registered in <code>gaderian.Translators</code>.
 * Converts an an input value into a {@link org.ops4j.gaderian.internal.ServicePoint}.
 *
